    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
			...
			<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-11 col-xxl-7">
					<div class="row mb-3">
						<input name="consulta" id="txt_consulta" placeholder="Busque pelo ID, serial modelo, data de entrega ou localização." type="text" class="form-control input fonte">
					</div>
			</div>
			<div>
						...
						<table id="tabela" class="table table-hover">
							<thead>
								<tr>
									...
									<th class="text-center align-items fonte">Serial</th>
									<th class="text-center align-items fonte">Modelo</th>
									<th class="text-center align-items fonte">Data de entrega</th>
									<th class="text-center align-items fonte">Localização</th>
							...
							<tbody>
								<?php
									while($receber_cadastros = mysqli_fetch_array($query_cadastros))
									{
										...
										echo "<td class='text-center fonte'>".$receber_cadastros['serial']."</td>";
										echo "<td class='text-center fonte'>".$receber_cadastros['modelo']."</td>";
										echo "<td class='text-center fonte'>".$receber_cadastros['dt_entrada']."</td>";
										echo "<td class='text-center fonte'>".$receber_cadastros['localizacao']."</td>";
										echo "<td class='text-center fonte'>
												<button onclick=\"location.href='editarchrome.php?ID=$receber_cadastros[ID]';\" class='btn btn-primary btn-e'>
													<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-fill' viewBox='0 0 16 16'>
														<path d='M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z'/>
													</svg>
												</button>
												<button onclick=\"if(confirm('Tem certeza que deseja excluir?')){location.href='excluirchrome.php?ID=$receber_cadastros[ID]';}else{false;}\" class='btn btn-danger btn-e'>
